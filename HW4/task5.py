...
with open('F:/GB/Courses/Python1/Homeworks/HW4/task5_1.txt') as file1, open('F:/GB/Courses/Python1/Homeworks/HW4/task5_2.txt') as file2:
...
with open('F:/GB/Courses/Python1/Homeworks/HW4/task5_result.txt', 'w') as file_result:
    file_result.write(polynomial)
